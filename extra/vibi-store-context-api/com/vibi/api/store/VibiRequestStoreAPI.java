...
public class VibiRequestStoreAPI implements IVibiStoreAPI { // WARNING: Change this name class for only 1 DB name only

    private static volatile VibiRequestStoreAPI instance;
    private Connection connection;
    private final String dbPath;
    private static final String BASE_DIR = Constants.STORE_API_DEFAULT_PATH; // WARNING: Change this BASE_DIR

    // Private constructor to ensure singleton pattern
    private VibiRequestStoreAPI() throws SQLException {
    ...
    /**
     * Get instance of VibiRequestStoreContextAPI (thread-safe double-checked locking)
     * Database name will automatically be set to the class name (e.g., "VibiRequestStoreContextAPI.db")
     * 
     * @return Unique instance of the class
     * @throws SQLException If error occurs during database initialization
     */
    public static VibiRequestStoreAPI getInstance() throws SQLException {
        if (instance == null) {
            synchronized (VibiRequestStoreAPI.class) {
                if (instance == null) {
                    instance = new VibiRequestStoreAPI();
                }
            }
        }
        return instance;
