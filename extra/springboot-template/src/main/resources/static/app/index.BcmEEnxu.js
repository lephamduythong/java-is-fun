...
}`],encapsulation:3});let hs=Oe;function hb(n,t){const e=n.clone({setHeaders:{"CUSTOM-HEADER":"CUTE"}});return console.log("HTTP Request:",e),t(e).pipe(_p(r=>{r instanceof Ir&&console.log("HTTP Response:",r)}),dc(r=>(console.error("HTTP Error:",r),mp(()=>r))))}Cw(hs,{providers:[eb(rb([hb]))]}).catch(n=>console.error(n));
